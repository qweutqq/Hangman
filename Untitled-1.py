...
def game():  
    ...
    print('Чтобы сделать ставку, введите через ПРОБЕЛЫ БЕЗ СКОБОК: [Cумма ставки (мин. 100 тёмкинсов)] [выбранный коэф.] [последнее число диапазона чисел] (к примеру: 500 4 10000)')
...
print('Добро пожаловать в игру "Числовая угадайка". Меня зовут бот Тёмка! Я помогу тебе освоиться в игре. Чтобы продолжить, введи "Далее"')
next = input()
while next.lower() != 'далее':
    next = input('Чтобы продолжить, введи "Далее"')
